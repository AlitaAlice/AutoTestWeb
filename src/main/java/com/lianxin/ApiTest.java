...
import com.lianxin.api.command.CommandFactory;
import com.lianxin.api.command.domain.DialogCase;
import com.lianxin.api.configs.ApiConfig;
import com.lianxin.api.excel.ExcelReader;
import com.lianxin.api.listeners.AutoTestListener;
import com.lianxin.api.listeners.RetryListener;
import com.lianxin.api.utils.FileUtil;
import com.lianxin.api.utils.RandomUtil;
import com.lianxin.api.utils.ReportUtil;
import com.lianxin.api.utils.SSLClient;
...
public class ApiTest extends TestBase {
	...
	public void init(@Optional("/api-config.xml") String envName) throws Exception {
		...
		ReportUtil.log("zhangxl_AutoTest");
...
//	}
	...
	public List<ApiDataBean>  transferData() throws IOException, InvalidFormatException {
		ReportUtil.log("BeforeTest_AutoTest");
		String path = "/root/job/autoTestCase4.xlsx";
//		String path = StringUtils.isEmpty(System.getProperty("excelPath")) ? "E://autoTestCase4.xlsx" : System.getProperty("excelPath");
		...
		for (int i = 0; i < dialogCaseList.size(); i++) {
			...
			for (int j = 0; j < dialogCase.getProcesses().size(); j++) {
				...
				ReportUtil.log(dataBean.toString());
				ReportUtil.log("P dou mei");
